...
public class TreeView extends Display {
    ...
    public static JComponent demo(String datafile, final String label) {
        ...
        Tree t = null;
        try {
        	ProtegeOWLTreeGenerator gen = new ProtegeOWLTreeGenerator();
        	gen.createOWLGraph();
            t = (Tree)gen.getTree();
            //System.out.println(t.isValidTree());
        } catch ( Exception e ) {
            e.printStackTrace();
            System.exit(1);
        }
        
        return getComponent(t, "label");
    }
    
    private static JComponent getComponent(Tree t, final String label) {
